...
public class TeamCategories {
    public static TeamCategoryHeader[] teams = new TeamCategoryHeader[] {
            ...
            new TeamCategoryHeader().category(TeamCategory.MARKETING).header("Marketing").imagePath("teams/financial_analysis.png").footer("Lorem ipsum"),
            new TeamCategoryHeader().category(TeamCategory.BANKING).header("Banking").imagePath("teams/financial_analysis.png").footer("Lorem ipsum"),
            ...
            new TeamCategoryHeader().category(TeamCategory.FINANCIAL_ANALYSIS).header("Financial Analysis Tools").imagePath("teams/financial_analysis.png").footer("Lorem ipsum")
    };
}
