...
object EventsData2016 {
    ...
    val data : List<DetailsItem<SpannableString>> = listOf(
            ...
            DetailsItem<SpannableString>("Name Surname", "Aditional text", "teams/events/stx2016/row_1.jpg", SpannableString("Some spannable content <b> bold content </b>")),
            DetailsItem<SpannableString>("Name Surname", "Aditional text", "teams/events/stx2016/row_3.jpg", SpannableString("Some spannable content <b> bold content </b>")),
            DetailsItem<SpannableString>("Name Surname", "Aditional text", "teams/events/stx2016/row_4.jpg", SpannableString("Some spannable content <b> bold content </b>")),
            DetailsItem<SpannableString>("Name Surname", "Aditional text",  "teams/events/stx2016/row_5.jpg",SpannableString("Some spannable content <b> bold content </b>"))
